...
function reponse(){
	...
	// méthode init
	this.init = function(projet, consigne, classes, numero, id, classe_id, titre, date, nombre_commentaires, nombre_jours, y, vignette, index){
		this.id = id;
		this.classe_id = classe_id;
		this.titre = titre;
		this.date = date;
		this.nombre_commentaires = nombre_commentaires;
		this.x = nombre_jours*(projet.largeur/consigne.nombre_jours_max);
		this.y = y;
